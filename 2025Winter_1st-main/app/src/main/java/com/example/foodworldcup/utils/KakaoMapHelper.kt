...
/** 카카오맵 관련 유틸리티 함수들을 모아놓은 객체입니다. MapActivity와 MyPageActivity에서 중복되던 카카오맵 열기 로직을 통합했습니다. */
object KakaoMapHelper {

    /**
     * 카카오맵에서 상세 정보 보기 (리뷰, 사진 등 확인 가능) MapActivity와 MyPageActivity에서 중복되던 로직을 통합했습니다.
     *
     * @param context 컨텍스트
